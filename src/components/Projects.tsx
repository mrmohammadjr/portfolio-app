  ...
  const projects: ProjectsType[] = [
    {
      ...
      poster: AI,
      description:
        "An AI chat , developed with NEXT JS and TYPESCRIPT libraries , using REDUXTOOLKIT to store global data, TAILWIND CSS for UI styles and using Groq SDK ai model",
    },
    {
      id: 2,
      title: "Online Store",
